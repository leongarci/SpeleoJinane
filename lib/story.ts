...
export const STORIES: StoryBeat[] = [
  ...
  },
  {
    ...
    lines: [
      "Les puits du fond.",
      "Quatre descentes, environ 100 mètres de corde.",
      "Reste dans le puits. Évite les piques et les cristaux.",
      "Trois paliers. Tu es prête ?",
    ],
    hint: "Gauche / droite pour esquiver. 3 chocs = retour au 1er puits.",
    next: "rappel",
    cta: "Descendre",
  },
];
